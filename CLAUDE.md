...
│   │   ├── composables/  # useMapUpload.js, useContentTabQuery.js (synchronise un onglet "Contenu" avec sa query string, voir composants admin/*Search.vue)
│   │   ├── utils/     # Utilitaires (conditions.js, playerProfiles.js, playerSessionMemory.js, themePreferences.js, generatorUtils.js, mapGrid.js, jwt.js, apiFetch.js)
