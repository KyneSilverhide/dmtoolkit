...
export const COMMAND_INDEX = [
  ...
  { tabKey: 'races', label: 'Races', icon: 'game-icons:vitruvian-man', keywords: 'races race autognome centaure demi-elfe demi-orc dhampire drakeide chromatique diamantin dragonborn elfe elfe astral fadette forgelier giff gith gnome hadozi halfelin hiboulin hobgobelin de feerie homme-lapin humain kender kobold minotaure nain plasmoide ressuscite sang maudit thri-kreen tieffelin sous-race taille vitesse langues bonus caracteristiques aidedd' },
  ...
  { tabKey: 'services', label: 'Services', icon: 'lucide:hand-coins', keywords: 'services depenses embauche messager peage transport voyage bateau prix aidedd' },
  { tabKey: 'conditions', label: 'États', icon: 'lucide:skull', keywords: 'etats etat conditions condition aveugle charme assourdi empoisonne paralyse petrifie entrave etourdi epuisement inconscient effraye agrippe invisible a terre incapable neutralise aidedd' },
