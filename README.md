...
- **Marchand** : boutique interactive avec panier, stock, négociation de prix, édition d'un marchand existant, et objets magiques (ajout manuel ou tirage aléatoire filtré par rareté) mis en évidence à la vente
